var pauser = 10000; //laver et delay på 5000 millisekunder
var img; //billederne som skal køres i slideren
var imgID = 0; //antal billeder i slideren
var imgsrc; //placeringen af billederne
var fadeOut = 900; //hastigheden billedet fader ud i millisekunder
var fadeIn = 500; //hastigheden billedet fader ind i millisekunder
...
function rotator() {  //Roterer mellem billerne
    ...
    imgsrc = 'img/' + img[imgID]; //vælger billedet ud fra navnet
